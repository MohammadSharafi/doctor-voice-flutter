...
abstract class IMainPageService {
  IMainPageService(this.dio);

  Future<UserDevicesList?> getUserDevicesList(UserDevicesListRequest model);
  final Dio dio;
}

class MainPageService extends IMainPageService with ChangeNotifier, CacheManager{
  MainPageService(Dio dio) : super(dio);
